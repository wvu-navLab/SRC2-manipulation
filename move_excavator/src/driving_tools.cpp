...
#include <move_excavator/driving_tools.h>
...
bool DrivingTools::RotateInPlace(move_excavator::RotateInPlace::Request &req, move_excavator::RotateInPlace::Response &res)
{
...
bool DrivingTools::CirculateBaseStation(move_excavator::CirculateBaseStation::Request  &req, move_excavator::CirculateBaseStation::Response &res)
{
...
bool DrivingTools::MoveForward(move_excavator::MoveForward::Request  &req, move_excavator::MoveForward::Response &res)
{
...
bool DrivingTools::Stop(move_excavator::Stop::Request  &req, move_excavator::Stop::Response &res)
{
  if (req.enableStop)
  {
